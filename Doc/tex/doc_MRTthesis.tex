...
\begin{describeopt}{affidavit}[\meta{choice}]
  Sets where the \cs{affidavit} is added if either \bverb|frontmatter=auto| or
  \bverb|backmatter=auto| is used. Possible \meta{choice}s are |front|, |back|
  and |off|. If |off| is used it doesn't get added automatically. Default value
  is |front|.
\end{describeopt}
...
\begin{describeopt}{lof}[\meta{choice}]
  Sets where the list of figures is added if either \bverb|frontmatter=auto| or
  \bverb|backmatter=auto| is used. Possible \meta{choice}s are |front|, |back|
  and |off|. If |off| is used it doesn't get added automatically. Default value
  is |front|.
\end{describeopt}
\begin{describeopt}{lot}[\meta{choice}]
  Sets where the list of tables is added if either \bverb|frontmatter=auto| or
  \bverb|backmatter=auto| is used. Possible \meta{choice}s are |front|, |back|
  and |off|. If |off| is used it doesn't get added automatically. Default value
  is |front|.
\end{describeopt}
