...
delimiters (so if you want to pass in a |]| to a macro with an optional argument
delimited by |[]| you'll need to use |[{foo]}]|, this is the same behaviour
encountered in \LaTeXe's optional arguments).
...
\makeatother
A few usage examples of the above defined macro can be seen in
\autoref{tab:util:ourmacro}.
